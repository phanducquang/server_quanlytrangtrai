...
//                        .hasAnyRole("admin")
                    .antMatchers(HttpMethod.GET,"/api/schedule/list","/api/schedule/listschedule","/api/schedule/**","/api/farms/list","/api/sections/list","/api/houses/list")
                        .permitAll()
                ...
                //quan_ly_hoat_dong
                    .antMatchers(HttpMethod.GET,"/api/pigs/list")
                        .hasAnyRole("quan_ly_heo_khu_cach_ly","admin")
                    .antMatchers(HttpMethod.GET,"/api/pigs/list")
                        .hasAnyRole("quan_ly_heo_khu_noc","admin")
                    .antMatchers(HttpMethod.GET,"/api/pigs/list")
                        .hasAnyRole("quan_ly_heo_khu_phoi","admin")
                    .antMatchers(HttpMethod.GET,"/api/pigs/list")
                        .hasAnyRole("quan_ly_heo_khu_mang_thai","admin")
                    .antMatchers(HttpMethod.GET,"/api/pigs/list")
                        .hasAnyRole("quan_ly_heo_khu_de","admin")
                    .antMatchers(HttpMethod.GET,"/api/pigs/list")
                        .hasAnyRole("quan_ly_heo_khu_cai_sua","admin")
                    .antMatchers(HttpMethod.GET,"/api/pigs/list")
                        .hasAnyRole("quan_ly_heo_khu_hau_bi","admin")
                    .antMatchers(HttpMethod.GET,"/api/pigs/list")
                        .hasAnyRole("quan_ly_heo_khu_8","admin")
                    .antMatchers(HttpMethod.GET,"/api/pigs/**")
                        .hasAnyRole("xem_thong_tin_heo","admin")
                ...
                //quan_ly_thiet_lap
                    .antMatchers(HttpMethod.GET,"/api/settings/list")
                        .hasAnyRole("xem_danh_sach_thiet_lap","admin")
