...
public class Pigs {
	...
	public Float getBorn_status() {
		return born_status;
	}

	public void setBorn_status(Float born_status) {
		this.born_status = born_status;
	}
	...
	public Integer getPrice_code() {
		return price_code;
	}

	public void setPrice_code(Integer price_code) {
		this.price_code = price_code;
	}
